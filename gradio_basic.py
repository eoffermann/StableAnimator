...
iface = gr.Interface(
    fn=run_inference,
    inputs=[
        gr.Textbox(label="Pretrained Model Path", value="path/checkpoints/SVD/stable-video-diffusion-img2vid-xt"),
        gr.Textbox(label="Validation Image Path", value="path/inference/case-1/reference.png"),
        gr.Textbox(label="Validation Control Folder", value="path/inference/case-1/poses"),
        gr.Textbox(label="Output Directory", value="path/basic_infer"),
        ...
        gr.Textbox(label="PoseNet Model Path", value="path/checkpoints/Animation/pose_net.pth"),
        gr.Textbox(label="Face Encoder Model Path", value="path/checkpoints/Animation/face_encoder.pth"),
        gr.Textbox(label="UNet Model Path", value="path/checkpoints/Animation/unet.pth"),
